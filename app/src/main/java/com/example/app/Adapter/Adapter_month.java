...
public class Adapter_month extends RecyclerView.Adapter<Adapter_month.ViewHolder> {
    ...
    public Adapter_month(Context context, ArrayList<String> month){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_row_month,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        AppDatabase database = Room.databaseBuilder(context, AppDatabase.class, "mydb")
                ...
                .build();
        RecyclerView rv_incomeDetails = holder.recyclerView;
        ...
        if(holder.cardView != null){
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putString("month",tmp);
                    Navigation.findNavController(view).navigate(R.id.action_SecondFragment_to_FifthFragment,bundle);
