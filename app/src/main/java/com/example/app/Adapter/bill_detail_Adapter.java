...
public class bill_detail_Adapter extends RecyclerView.Adapter<bill_detail_Adapter.ViewHolder> {

    private Context context;
    private ArrayList<bill_detail> bill_details;

    public bill_detail_Adapter(Context context, ArrayList<bill_detail> bill_details){
    ...
    private void onButtonShowPopupWindowClick(View view,bill_detail billDetails,LinearLayout layout) {
        ...
        AppDatabase database = Room.databaseBuilder(context, AppDatabase.class, "mydb")
                ...
                .build();
        bill_detail_DAO billDetailDao = database.bill_detailDao();
        ...
        buttonYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                billDetailDao.delete_bill_detail(billDetails);
                popupWindow.dismiss();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        bill_detail billDetails = bill_details.get(position);
        holder.text_id.setText(String.valueOf(position));
        holder.text_title.setText(billDetails.getName());
        holder.text_date.setText(billDetails.getFormattedDate());
        holder.text_cost.setText(billDetails.getCost());
        if(holder.btnDel != null){
            holder.btnDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    onButtonShowPopupWindowClick(view, billDetails, holder.layout);
                }
            });
        }
    }
